# River Crossing Problems: Goat-Grass-Cheetah and Missionaries-Cannibals
from collections import deque

def goat_grass_cheetah():
    """
    Solve the goat-grass-cheetah river crossing problem using BFS.
...
if __name__ == "__main__":
    print("Goat-Grass-Cheetah Problem Solution:")
    solution = goat_grass_cheetah()
    if solution:
